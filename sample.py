...
out_dir = 'out-no-train-sent' # ignored if init_from is not 'resume'
start = "<|endoftext|> The quick brown fox" # or "<|endoftext|>" or etc. Can also specify a file, use as: "FILE:prompt.txt"
...
if init_from == 'resume':
    ...
    raise ValueError("must specify use resume")
...
if load_meta:
    ...
    # See openai_public.for examples of arguments for specific encodings
    ...
    encode = lambda s: enc.encode(s, allowed_special=set(["<|endoftext|>"] + list(sentinel_tokens.keys())))
